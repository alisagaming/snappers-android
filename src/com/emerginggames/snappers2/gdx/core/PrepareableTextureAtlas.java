package com.emerginggames.snappers2.gdx.core;
 ...
 * Time: 10:57
 */
public class PrepareableTextureAtlas implements Disposable {
    ...
    public static class TextureAtlasData {
        public static class Page {
            ...
            public void prepare(){
                if (textureData == null)
                    textureData = new FileTextureData(textureFile, null, format, useMipMaps);
            ...
            public boolean isPrepared(){
                return textureData != null && textureData.isPrepared();
            }
    ...
    public PrepareableTextureAtlas() {
    }

    /** Loads the specified pack file using {@link com.badlogic.gdx.Files.FileType#Internal}, using the parent directory of the pack file to find the page
     * images. */
    public PrepareableTextureAtlas(String internalPackFile) {
        this(Gdx.files.internal(internalPackFile));
    }

    /** Loads the specified pack file, using the parent directory of the pack file to find the page images. */
    public PrepareableTextureAtlas(FileHandle packFile) {
        this(packFile, packFile.parent());
    }

    /** @param flip If true, all regions loaded will be flipped for use with a perspective where 0,0 is the upper left corner.
     * @see #PrepareableTextureAtlas(FileHandle) */
    public PrepareableTextureAtlas(FileHandle packFile, boolean flip) {
        this(packFile, packFile.parent(), flip);
    }

    public PrepareableTextureAtlas(FileHandle packFile, FileHandle imagesDir) {
        this(packFile, imagesDir, false);
    }

    /** @param flip If true, all regions loaded will be flipped for use with a perspective where 0,0 is the upper left corner. */
    public PrepareableTextureAtlas(FileHandle packFile, FileHandle imagesDir, boolean flip) {
        this(new TextureAtlasData(packFile, imagesDir, flip));
    }

    public PrepareableTextureAtlas(TextureAtlasData data) {
        load(data);
    }
    ...
    private void load (TextureAtlasData data) {
        ...
        for (TextureAtlasData.Page page : data.pages) {
            ...
            if (page.texture == null) {
                if (!page.isPrepared())
                    page.prepare();
                texture = new Texture(page.getTextureData());
    ...
    static public class AtlasRegion extends TextureRegion {
         ...
         * @see PrepareableTextureAtlas#findRegions(String) */
        public int index;
