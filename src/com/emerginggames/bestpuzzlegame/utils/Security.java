...
public class Security {
     ...
     * contains the {@link com.emerginggames.bestpuzzlegame.Consts.PurchaseState} and product ID of the purchase.
    ...
    public static ArrayList<VerifiedPurchase> verifyPurchase(String signedData, String signature) {
        ...
        if (!TextUtils.isEmpty(signature)) {
             ...
             */
            String base64EncodedPublicKey = Settings.getInAppKey();
