...
import com.emerginggames.bestpuzzlegame.gdx.IAppGameListener;
...
import com.emerginggames.bestpuzzlegame.utils.GInAppStore;
import com.emerginggames.bestpuzzlegame.utils.Store;
import com.emerginggames.bestpuzzlegame.utils.TapjoyPointsListener;
import com.emerginggames.bestpuzzlegame.utils.Utils;
import com.emerginggames.bestpuzzlegame.view.*;
import com.emerginggames.bestpuzzlegame.view.AdController;
...
public class GameActivity extends AndroidApplication {
    ...
    com.pad.android.iappad.AdController mLeadBoltAdController;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //mLeadBoltAdController = new com.pad.android.iappad.AdController(this, "10050639");
        //mLeadBoltAdController.showAd();
    }
    ...
    class GameListener implements IAppGameListener {
        ...
        public void levelSolved(Level level, final int score) {
            ...
            if (Math.random() < prefs.getChartboostChance()) {
                if (!displayedSomething && mChartBoost.hasCachedInterstitial(mCurrentCbCache)) {
