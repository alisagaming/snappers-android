...
public class TJCVirtualGoods extends Activity implements View.OnClickListener
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		{
			TapjoyLog.i(TAPJOY_VIRTUAL_GOODS, "*** Loading saved data from bundle ***");
			urlParams = savedInstanceState.getString(BUNDLE_URL_PARAMS);
		}
		
		TapjoyLog.i(TAPJOY_VIRTUAL_GOODS, "urlParams: " + urlParams);
		
		virtualGoodUtil = new TJCVirtualGoodUtil(this, clientPackage);
		
		tapjoyVGConnection = new TJCVirtualGoodsConnection(TapjoyConstants.TJC_SERVICE_URL, urlParams);
	...
	protected void onSaveInstanceState (Bundle outState)
	{
		...
		outState.putString(BUNDLE_URL_PARAMS, urlParams);
	}
...
//		TapjoyLog.i("COLOR", "blue: " + Integer.toHexString(blue)+ ", int: " + blue);
	...
	public static interface TapjoyDownloadListener
	{
		...
		public void onDownloadedItems(ArrayList<VGStoreItem> purchasedItemArray);
	}
